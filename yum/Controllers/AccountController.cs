...
namespace yum.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(Customer user)
        {
            ...
            {
                var usr = db.Customers.Where(u => (u.Email == user.Email && u.Password == user.Password)).FirstOrDefault();
                if(usr != null)
                {
        ...
        public async Task<ActionResult> Register(Customer user)
        {
            ...
            using(var db = new AppDbContext())
            {
                ...
                if(c != null)
                {
                    ViewBag.ErrorMsg = "User Exists!";
                }
                else
                {
                    db.Customers.Add(user);
                    db.SaveChanges();
                    ViewBag.SuccessMsg = "User Added Succesfully";
                }
            }
            return View();
        }
